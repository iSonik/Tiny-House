...
const PhotoRenderer = (props) => {
    ...
    const renderDefaultPhoto = ({ wrapped } = {}) => {
        ...
        return (React__namespace.createElement("img", { alt: alt, ...(srcSet ? { srcSet, sizes } : null), src: src, style: wrapped ? { display: "block", width: "100%", height: "100%" } : style, ...rest }));
    };
...
const useEventCallback = (fn) => {
    ...
    return React__namespace.useCallback((...args) => { var _a; return (_a = ref.current) === null || _a === void 0 ? void 0 : _a.call(ref, ...args); }, []);
};

const useContainerWidth = (breakpoints, defaultContainerWidth) => {
    const [containerWidth, setContainerWidth] = React__namespace.useState(defaultContainerWidth);
    const [scrollbarWidth, setScrollbarWidth] = React__namespace.useState();
